...
const int output_size_A = 84 * 3024;  // yolo_num_class * yolo_num_boxes
const int output_size_B = 140 * 252;  // depth_pixels
...
const std::string file_name_A = "Model_Yolo_v8n.ort";
const std::string file_name_B = "Model_Depth.ort";
