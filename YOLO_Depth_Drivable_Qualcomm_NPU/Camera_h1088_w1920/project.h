...
GLint yuvTexLoc = 0;
const GLsizei camera_width = 1920;
const GLsizei camera_height = 1088;
const GLsizei pixelCount = camera_width * camera_height;
const int output_size_A = 6 * 4620;  // [x, y, w, h, max_score, max_indices] * yolo_num_boxes
...
const std::string file_name_A = "Model_Yolo_v9c_f16_h1088_w1920.onnx";
