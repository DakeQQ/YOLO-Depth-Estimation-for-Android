...
17. Drivable area detection is less accurate due to water, reflections, shadows, and low light.
18. For high-resolution screens, use GL_LINE_STRIP to draw the drivable area (the settings at GLRender.java - lines 345 & 350), or you won't see anything.
19. We will make the model exported method public later.
20. See more about the project: https://dakeqq.github.io/overview/
...
18. 可行驶区域检测会受到积水或光滑地面的反光影响，阴影交界处, 昏暗地区等等的精确度也较低。
19. 对于高屏幕分辨率的手机，请改使用GL_LINE_STRIP来绘制可行驶区域（GLRender.java-第345 & 350行）, 否則你啥也看不見。
20. 我们未来会提供转换导出模型的方法。
21. 看更多項目: https://dakeqq.github.io/overview/
# YOLO - 性能 Performance
