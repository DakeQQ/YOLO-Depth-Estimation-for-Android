...
ultralytics_engine_path = '/Users/jzhan378/PycharmProjects/pythonProject/.venv/lib/python3.11/site-packages/ultralytics/engine/'  # The original ultralytics/engine path which was stored in the python packages.
ultralytics_nn_path = '/Users/jzhan378/PycharmProjects/pythonProject/.venv/lib/python3.11/site-packages/ultralytics/nn/'  # The original ultralytics/nn path which was stored in the python packages.
...
# Load a model
model = YOLO("/Users/jzhan378/Downloads/YOLO/yolo11x.pt")  # Load an official model, or specify your own model path. The version number must match EXPORT_YOLO_VERSION.
