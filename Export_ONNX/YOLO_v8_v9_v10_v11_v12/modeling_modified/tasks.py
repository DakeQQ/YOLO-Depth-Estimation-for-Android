...
from .yolo_config import EXPORT_YOLO_VERSION, EXPORT_YOLO_RESIZE
...
class BaseModel(torch.nn.Module):
    ...
    def _predict_once(self, x, profile=False, visualize=False, embed=None):
        ...
        Returns:
            (torch.Tensor): The last output of the model.
        """
        x_4 = self.model[4](self.model[3](self.model[2](self.model[1](self.model[0](torch.nn.functional.interpolate(
            x,
            EXPORT_YOLO_RESIZE,
            mode="bilinear",
            align_corners=True,
        ))))))
        if EXPORT_YOLO_VERSION == 12:
            x_6 = self.model[6](self.model[5](x_4))
            x_8 = self.model[8](self.model[7](x_6))
            x_11 = self.model[11](self.model[10]([self.model[9](x_8), x_6]))
            x_14 = self.model[14](self.model[13]([self.model[12](x_11), x_4]))
            x_17 = self.model[17](self.model[16]([self.model[15](x_14), x_11]))
            x_19 = self.model[19]([self.model[18](x_17), x_8])
            x_20 = self.model[20](x_19)
            result = self.model[21]([x_14, x_17, x_20])
        elif (EXPORT_YOLO_VERSION == 10) | (EXPORT_YOLO_VERSION == 11):
            x_6 = self.model[6](self.model[5](x_4))
            x_10 = self.model[10](self.model[9](self.model[8](self.model[7](x_6))))
